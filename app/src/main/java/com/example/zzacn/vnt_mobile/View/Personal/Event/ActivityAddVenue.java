...
import com.example.zzacn.vnt_mobile.Adapter.AddVenueAdapter;
...
public class ActivityAddVenue extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ActivityAddVenue.this, ActivityAddEvent.class);
    ...
    void searchByType(int serviceType) {
        ...
        if (!etSearch.getText().toString().equals("")) {
            ...
            Toast.makeText(ActivityAddVenue.this, getResources().getString(R.string.text_PleaseEnterASearchKey), Toast.LENGTH_SHORT).show();
        }
    }

    private void search(String url, final int serviceType) {

        final AddVenueAdapter addVenueAdapter;
        ...
        addVenueAdapter = new AddVenueAdapter(recyclerView, services, getApplicationContext(), event, ActivityAddVenue.this);
        recyclerView.setAdapter(addVenueAdapter);
        addVenueAdapter.notifyDataSetChanged();

        //set load more listener for the RecyclerView adapter
        addVenueAdapter.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                if (finalListService.size() < Integer.parseInt(finalArr.get(2))) {
                    ...
                    recyclerView.post(new Runnable() {
                        public void run() {
                            addVenueAdapter.notifyItemInserted(finalListService.size() - 1);
                        }
                    });
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            addVenueAdapter.notifyItemRemoved(finalListService.size());
